...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
                ...
                AppComponent.prototype.getData = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.apollo.query({ query: graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["", ""], ["", ""]), Object(_querys_common__WEBPACK_IMPORTED_MODULE_4__["common"])(this.limit, this.period)), context: { headers: { "idface": "" + this.idFace } } }).toPromise()];
                                case 1:
                                    a = _a.sent();
                                    return [4 /*yield*/, this.apollo.query({ query: graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["", ""], ["", ""]), Object(_querys_community__WEBPACK_IMPORTED_MODULE_6__["community"])(this.limit, this.period)), context: { headers: { "idface": "" + this.idFace } } }).toPromise()];
                                case 2:
                                    b = _a.sent();
                                    return [4 /*yield*/, this.apollo.query({ query: graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["", ""], ["", ""]), Object(_querys_investmet__WEBPACK_IMPORTED_MODULE_7__["investment"])(this.limit, this.period)), context: { headers: { "idface": "" + this.idFace } } }).toPromise()];
                                case 3:
                                    c = _a.sent();
                                    return [4 /*yield*/, this.apollo.query({ query: graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["", ""], ["", ""]), Object(_querys_affinty__WEBPACK_IMPORTED_MODULE_8__["affinity"])(this.limit, this.period)), context: { headers: { "idface": "" + this.idFace } } }).toPromise()];
                                case 4:
                                    d = _a.sent();
                                    return [4 /*yield*/, this.apollo.query({ query: graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(__makeTemplateObject(["", ""], ["", ""]), Object(_querys_conversation__WEBPACK_IMPORTED_MODULE_9__["conversation"])(this.limit, this.period)), context: { headers: { "idface": "" + this.idFace } } }).toPromise()];
                                case 5:
                                    e = _a.sent();
                                    Promise.all([a, b, c, d, e]).then(function (result) {
                                        _this.commons = result[0].data.pulse.facebook.common;
                                        _this.community = result[1].data.pulse.facebook.community;
                                        _this.investment = result[2].data.pulse.facebook.investmentReturn;
                                        _this.affinity = result[3].data.pulse.facebook.affinity;
                                        _this.conversation = result[4].data.pulse.facebook.conversation;
                                        _this.trasnsfomData();
                                        _this.apollo.getClient().writeData({ data: {} });
                                    });
                                    return [2 /*return*/];
                            }
                        });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
            /* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_1__);
            var comparator = function (array, days) {
                ...
                dates.map(function (el, index) {
                    ...
                    if (el >= lastMonday && el <= lastNumDay && el != "X") {
                        prev += data[index];
                    }
