...
const common = (limit = 7, period = "DL") => {
    let end = moment__WEBPACK_IMPORTED_MODULE_1__().format('MM/DD/YYYY');
    let start = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(limit, 'days').format("MM/DD/YYYY");
    return `
query{
...
const transGraph = (data, limit = 7, period = "DL") => {
    let result = [];
    let days = ["Contador"];
    let end = moment__WEBPACK_IMPORTED_MODULE_1__();
    let start = moment__WEBPACK_IMPORTED_MODULE_1__().subtract(limit - 1, 'days');
    while (start <= end) {
        ...
        if (key != "__typename") {
            for (let i = 0; i < days.length; i++) {
                if (i == 0) {
                    ...
                    let index = data[key].find(e => moment__WEBPACK_IMPORTED_MODULE_1__(e.date).add(1, 'days').format("MM/DD/YYYY") == days[i]);
